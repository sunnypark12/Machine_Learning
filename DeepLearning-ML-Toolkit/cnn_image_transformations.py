...
def create_training_transformations():
    ...
    """
    return v2.Compose([v2.ToImage(), v2.ToDtype(torch.float32), v2.RandomHorizontalFlip(p=0.2),  v2.RandomApply([v2.RandomRotation(degrees=36)], p=0.2)])
...
def create_testing_transformations():
    ...
    RETURN: torchvision.transforms.v2.Compose object
    """
    return v2.Compose([v2.ToImage(), v2.ToDtype(torch.float32)])
